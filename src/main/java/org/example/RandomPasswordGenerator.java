...
public class RandomPasswordGenerator implements org.example.PasswordGenerator {
    ...
    public String generatePassword() {
        ...
        CharacterRule digitCaseRule = new CharacterRule(lowerCaseChars);
        ...
        // 0 ~ 12
        return gen.generatePassword((int)(Math.random() * 13), splCharRule, lowerCaseRule, upperCaseRule, digitCaseRule);
    }
